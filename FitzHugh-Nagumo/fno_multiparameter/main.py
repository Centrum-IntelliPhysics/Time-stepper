...
################################################################
reader = MatReader('../data/multiparameter/data_FHN')
...
torch.save(model, save_models_to+'FHN_multiparameter')
...
scipy.io.savemat(save_results_to+'FHN_multiparameter_test.mat', 
